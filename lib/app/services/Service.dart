...
class AppConfig {
  static String mainApiUrl = "https://example.com";
  static String authenticateUrl = "https://example.com/auth";
  static String backupApiUrl = "https://example.com/backup";
  static int timeoutService = 60000;
}
